...
.PHONY: build
build:
	docker build --rm=true -t repo/centos-security-advisories-api .
...
clean:
	...
	-docker rmi "repo/centos-security-advisories-api"

.PHONY: push
push:
	docker push repo/centos-security-advisories-api
